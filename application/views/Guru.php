  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center mt-5">
        <h1 class="heading" data-aos="fade-up">Data Guru</h1>
          ...
          <div class="property-slider">
            ...
            foreach ($data_guru->result_array() as $row) :
              ...
              <div class="property-content">
                <div class="price mb-2"><span><?php echo $nip;?>,<?php echo $nama_guru;?></span></div>
                <div>


                  <span class="city d-block mb-3"><?php echo $mapel;?></span>
