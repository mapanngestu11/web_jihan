                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'Admin/Absen/tambah_absen_siswa'; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="editModal<?php echo $id_absen;?>" tabindex="-1" role="dialog" aria-labelledby="editModal<?php echo $id_absen;?>" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form action="<?php echo base_url() . 'Admin/Absen/update_absen_siswa'; ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                <div class="modal-body">
                  <div class="row form-group">
                    <div class="col-md-12">
                      <label>Nisn.</label>
  ...
  <div class="modal fade" id="hapusModal<?php echo $id_absen;?>" tabindex="-1" role="dialog" aria-labelledby="hapusModal<?php echo $id_absen;?>" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url() . 'Admin/Absen/delete_absen_siswa'; ?>" method="POST">
          <div class="modal-body">
            <input type="hidden" name="id_absen" value="<?php echo $id_absen;?>">
